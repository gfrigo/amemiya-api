...
class Execute:
    ...
    class Select:
        """
            Class to handle selections from the database based on predefined patterns.
        """
        @staticmethod
        def from_string(cursor, select_stmt: str) -> list:
            if not select_stmt:
                raise ValueError("No select statement has been provided.")
    ...
    class Insert:
        """
            Class to handle insertions to the database based on predefined patterns.
        """
        @staticmethod
    ...
    class Update:
        """
            Class to handle updates to the database based on predefined patterns.
        """
        @staticmethod
        def from_string(cursor, update_stmt: str, values: list[tuple] | tuple) -> None:
            if not update_stmt:
                raise ValueError("No insert statement has been provided.")
    ...
    class Delete:
        """
            Class to handle deletes to the database based on predefined patterns.
        """
        @staticmethod
        def from_string(cursor, delete_stmt: str) -> None:
            if not delete_stmt:
                raise ValueError("No delete statement has been provided.")
